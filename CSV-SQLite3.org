...
#+date:2019-09-29 23:44
#+macro: version Version 0.0.48
...
: csvsqlite --export <db> | -e <db-name>

{{{subheading(Set a Log Level)}}}

: csvsqlite --log-level <value:0..10> | -l <value:0..10>
...
#+caption: Add Scripts Tests to package.json
#+name:add-scripts-tests-to-package.json
#+header: :results output :exports both
#+header: :dir LogReader
#+BEGIN_SRC js
const fs = require('fs');
const p = JSON.parse(fs.readFileSync('package.json', 'utf8'));
p.scripts = {"tests": "jest"};
fs.writeFileSync('package.json', JSON.stringify(p, null, 2));
#+END_SRC

#+caption:Package.json with Scripts Tests
#+name:cat-package.json-with-scripts-tests
#+header: :dir LogReader
#+header: :results output :exports both
#+BEGIN_SRC sh
cat package.json
