...
#+author:LOLH
#+date:<2019-10-20 Sun 17:45>
#+macro: version Version 0.0.82
...
#+caption:Command-Line-Usage Module
...
#+begin_src js +n :tangle index.js
  ...
  if (options.hasOwnProperty('csv')) { // process --csv ACCT YEAR
      ...
      csv_file_parser.options = options;
...
#+begin_src js -n :tangle lib/csv/file_transformer.js
  ...
  const db      = require('./lib/sql/db').attach(exports.transformer.options.attach);
