...
tangle: CSV-SQLite3.org
	emacs --batch CSV-SQLite3.org \
	--eval '(org-babel-tangle-file "CSV-SQLite3.org")'

weave: texi info

texi: CSV-SQLite3.texi
CSV-SQLite3.texi: CSV-SQLite3.org
	emacs --batch CSV-SQLite3.org \
...
info install-info: docs/csv-sqlite3.info | docs-dir
docs/csv-sqlite3.info: CSV-SQLite3.texi
	makeinfo --output=docs/ CSV-SQLite3.texi

install-docs: install-info install-pdf

pdf install-pdf: docs/CSV-SQLite3.pdf | docs-dir
docs/CSV-SQLite3.pdf: CSV-SQLite3.texi
	pdftexi2dvi -q -c CSV-SQLite3.texi
	mv CSV-SQLite3.pdf docs/

open-pdf: docs/CSV-SQLite3.pdf
	open csv-sqlite3.pdf
